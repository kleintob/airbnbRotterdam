...
model_resid_squared <- lm(log_squared_residuals ~ review_scores_rating_standardized + accommodates 
                          + Centrality + Quietness + Coolness + Fanciness, data = listings_clean_filtered)
```
